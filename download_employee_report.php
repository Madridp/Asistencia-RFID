...
foreach ($empleados as $empleado) {
    $hoja->setCellValueByColumnAndRow(1, $y, $empleado->nombre);
    $hoja->setCellValueByColumnAndRow(2, $y, $empleado->presence_count);
    $hoja->setCellValueByColumnAndRow(3, $y, $empleado->absence_count);
    $y++;
}
